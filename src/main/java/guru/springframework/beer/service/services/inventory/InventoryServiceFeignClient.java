...
import guru.springframework.beer.service.config.FeignClientConfig;
...
@FeignClient(name = "beer-inventory-service", fallback = InventoryFailoverServiceFeignClientImpl.class, configuration = FeignClientConfig.class)
