package guru.springframework.beer.service.web.controller;
...
import guru.springframework.beer.service.web.controller.BeerController;
...
import guru.springframework.beer.service.services.BeerService;
...
class BeerControllerTest {
    ...
    void getBeerById() throws Exception {
        given(beerService.getById(any(), ArgumentMatchers.eq(false))).willReturn(getValidBeerDto());
